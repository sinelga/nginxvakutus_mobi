...
function dart_precompiled($collectedClasses) {
  ...
  function show_closure() {
  }
  show_closure.builtin$cls = "show_closure";
  if (!"name" in show_closure)
    show_closure.name = "show_closure";
  $desc = $collectedClasses.show_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  show_closure.prototype = $desc;
  function NullTreeSanitizer0() {
  }
  NullTreeSanitizer0.builtin$cls = "NullTreeSanitizer0";
  if (!"name" in NullTreeSanitizer0)
    NullTreeSanitizer0.name = "NullTreeSanitizer0";
  $desc = $collectedClasses.NullTreeSanitizer0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  NullTreeSanitizer0.prototype = $desc;
  ...
  function JsObject(_js0$_jsObject) {
  ...
  function JsFunction(_js0$_jsObject) {
    this._js0$_jsObject = _js0$_jsObject;
  }
  ...
  function JsArray(_js0$_jsObject) {
    this._js0$_jsObject = _js0$_jsObject;
  }
  ...
  function createMediaObject_closure() {
  }
  createMediaObject_closure.builtin$cls = "createMediaObject_closure";
  if (!"name" in createMediaObject_closure)
    createMediaObject_closure.name = "createMediaObject_closure";
  $desc = $collectedClasses.createMediaObject_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  createMediaObject_closure.prototype = $desc;
  ...
  function ForMark(Title, Description, ImageLink, Cont, PubDate) {
    this.Title = Title;
  ...
  ForMark.builtin$cls = "ForMark";
  if (!"name" in ForMark)
    ForMark.name = "ForMark";
  $desc = $collectedClasses.ForMark;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ForMark.prototype = $desc;
  ...
  function FunctionProxy(_js$_jsFunction, _thisArg, _js$_jsObject) {
    this._js$_jsFunction = _js$_jsFunction;
